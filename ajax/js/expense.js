jQuery(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        if (!$("#code").val() || $("#code").val().length === 0) {
        ...
        } else if (!$("#expense_type").val() || $("#expense_type").val().length === 0) {
            swal({
                title: "Error!",
                text: "Please select a Expense Type",
                type: "error",
                timer: 2000,
                showConfirmButton: false,
            });
            ...
            $.ajax({
                url: "ajax/php/expense.php", // Adjust the URL based on your needs
                type: "POST",
                data: formData,
                async: false,
                cache: false,
    ...
    $(document).on("click", ".delete-expense", function (e) {
        ...
        if (!name || name === "") {
            swal({
                title: "Error!",
                text: "Please select a Expense first.",
                type: "error",
                timer: 2000,
                showConfirmButton: false,
            });
        ...
        swal(
            {
                title: "Are you sure?",
                text: "Do you want to delete '" + name + "' Expense?",
                type: "warning",
    ...
    $(document).on("click", ".select-expense", function () {
        ...
        $("#expense_type").val($(this).data("expense_type"));
