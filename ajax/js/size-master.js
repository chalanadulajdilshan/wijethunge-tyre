jQuery(document).ready(function () {
  ...
  $("#create").click(function (event) {
    ...
    if (!$("#code").val() || $("#code").val().length === 0) {
      ...
      $.ajax({
        url: "ajax/php/size-master.php", // Adjust the URL based on your needs
        type: "POST",
        data: formData,
        async: false,
        cache: false,
        ...
        success: function (result) {
          ...
          if (result.status === "success") {
            swal({
              title: "Success!",
              text: "Size Master added Successfully!",
              type: "success",
              timer: 2000,
              showConfirmButton: false,
            });
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          if (result.status == "success") {
            swal({
              title: "Success!",
              text: "Size Master updated Successfully!",
              type: "success",
              timer: 2500,
              showConfirmButton: false,
            });
  ...
  // Delete Payment Type
  $(document).on("click", ".delete-size-master", function (e) {
    e.preventDefault();
    ...
    if (!name || name === "") {
      swal({
        title: "Error!",
        text: "Please select a Size Master first.",
        type: "error",
        timer: 2000,
        showConfirmButton: false,
      });
    ...
    swal(
      {
        title: "Are you sure?",
        text: "Do you want to delete '" + name + "' size master?",
        type: "warning",
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if (response.status === "success") {
                swal({
                  title: "Deleted!",
                  text: "Size Master has been deleted.",
                  type: "success",
                  timer: 2000,
                  showConfirmButton: false,
                });
